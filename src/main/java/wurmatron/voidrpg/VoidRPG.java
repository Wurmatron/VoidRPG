...
import wurmatron.voidrpg.common.cube.CubeArmor;
...
public class VoidRPG {
		...
		public void onInit (FMLInitializationEvent e) {
				...
				CubeRegistry.INSTANCE.registerCube(new CubeArmor("armorLight", VoidRPGBlocks.armorLight, new ResourceLocation(Global.MODID, "textures/cube/lightArmor.png"), 0.1, 1, 50, 4096, new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET}, "cube.lightArmor.description", 0));
				CubeRegistry.INSTANCE.registerCube(new CubeArmor("armorHeavy", VoidRPGBlocks.armorHeavy, new ResourceLocation(Global.MODID, "textures/cube/heavyArmor.png"), 0.5, 5, 200, 4096, new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET}, "cube.heavyArmor.description", 0));
				CubeRegistry.INSTANCE.registerCube(new CubeArmor("armorReinforced", VoidRPGBlocks.armorReinforced, new ResourceLocation(Global.MODID, "textures/cube/reinforcedArmor.png"), 0.25, 5, 200, 4096, new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET}, "cube.reinforcedArmor.description", 0));
				...
				CubeRegistry.INSTANCE.registerCube(new CubeArmor("armorCardboard", VoidRPGBlocks.armorCardboard, new ResourceLocation(Global.MODID, "textures/cube/cardboard.png"), 0.1, 5, 200, 4096, new EntityEquipmentSlot[] {EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST, EntityEquipmentSlot.LEGS, EntityEquipmentSlot.FEET}, "cube.cardBoardArmor.description", 0));
