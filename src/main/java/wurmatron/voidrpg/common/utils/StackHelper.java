...
public class StackHelper {
		...
		public static boolean areItemsEqual(ItemStack a, ItemStack b) {
				if (a != null && b != null && a.getUnlocalizedName().equals(b.getUnlocalizedName()) && a.getItemDamage() == b.getItemDamage() && a.stackSize == b.stackSize)
						if (a.getTagCompound() != null && b.getTagCompound() != null && a.getTagCompound().equals(b.getTagCompound()))
								return true;
						else if (a.getTagCompound() == null && b.getTagCompound() == null) return true; return false;
		}
