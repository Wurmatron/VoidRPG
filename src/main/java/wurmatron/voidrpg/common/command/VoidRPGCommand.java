				...
				if (args.length > 0) {
					if (args[0].equalsIgnoreCase("version")) {
						...
						if (sender.getCommandSenderEntity() instanceof EntityPlayer)
							PacketHandler.sendTo(new SendFileMessage(JsonHandler.convertCubeToJson(new StringCube("jsonTest", "minecraft", "dirt", new ResourceLocation("minecraft", "textures/blocks/dirt.png"), 0.2, 1, 2, 2500, "head,chest,legs,boots", "cube.jsonTest.description")), NBT.JSON_CUBE), (EntityPlayerMP) sender.getCommandSenderEntity());
						break;
