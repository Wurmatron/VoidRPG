...
public class CubeRegistry {
		...
		public static void addDefaultCubes() {
				...
				CubeRegistry.registerCube(new NanoTech()); CubeRegistry.registerCube(new WaterWalking());
				...
				CubeRegistry.registerCube(new DamageConverter()); CubeRegistry.registerCube(new Flippers());
				CubeRegistry.registerCube(new Stealth()); CubeRegistry.registerCube(new Jetpack());
