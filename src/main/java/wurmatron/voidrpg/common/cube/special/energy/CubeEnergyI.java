...
public class CubeEnergyI implements ICube, IEnergyCube {
		...
		public Block getBlock () {
				return VoidRPGBlocks.energyStorageI;
		}

		@Override
		public ResourceLocation getTexture () {
				return new ResourceLocation(Global.MODID, "texutes/cube/energyI.png");
		}
		...
		public String getDescription () {
				return "cube.energyI.description";
		}
