...
public class CubeEnergyV implements ICube, IEnergyCube {
		...
		public Block getBlock () {
				return VoidRPGBlocks.energyStorageV;
		}

		@Override
		public ResourceLocation getTexture () {
				return new ResourceLocation(Global.MODID, "texutes/cube/energyV.png");
		}
		...
		public String getDescription () {
				return "cube.energyV.description";
		}
