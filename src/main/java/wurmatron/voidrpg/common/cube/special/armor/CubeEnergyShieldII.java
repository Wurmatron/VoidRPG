...
public class CubeEnergyShieldII implements ICube, IProtectionCube {

		@Override
		public String getUnlocalizedName () {
				return "energyShieldII";
		}

		@Override
		public Block getBlock () {
				return VoidRPGBlocks.armorEnergyShieldII;
		}

		@Override
		public ResourceLocation getTexture () {
				return new ResourceLocation(Global.MODID, "textures/cube/energyShieldII.png");
		}
		...
		public void applyEffect(EntityPlayer player, CubeData data, ItemStack stack) {
				if (data.damage > 0 && Loader.isModLoaded("tesla")) {
						data.damage -= 5;
						TeslaHelper.consumePower(stack, 30);
				}
		}
		...
		public String getDescription () {
				return "cube.energyShieldII.description";
		}
