...
public class CubeEnergyIII implements ICube, IEnergyCube {
		...
		public Block getBlock () {
				return VoidRPGBlocks.energyStorageIII;
		}

		@Override
		public ResourceLocation getTexture () {
				return new ResourceLocation(Global.MODID, "texutes/cube/energyIII.png");
		}
		...
		public String getDescription () {
				return "cube.energyIII.description";
		}
