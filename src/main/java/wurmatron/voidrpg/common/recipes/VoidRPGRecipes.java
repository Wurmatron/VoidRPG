...
public class VoidRPGRecipes {
		...
		private static void addShapedRecipes () {
				...
				GameRegistry.addRecipe(new ShapedOreRecipe(VoidRPGItems.itemStaff, "XAX", "BSB", " S ", 'X', Blocks.DIAMOND_BLOCK, 'A', ItemMaterial.createMaterial("creationCrystal"), 'B', Blocks.EMERALD_BLOCK, 'S', Items.DIAMOND));
				GameRegistry.addRecipe(new ShapedOreRecipe(VoidRPGItems.itemStaff, "BAB", "XSX", " S ", 'X', Blocks.DIAMOND_BLOCK, 'A', ItemMaterial.createMaterial("creationCrystal"), 'B', Blocks.EMERALD_BLOCK, 'S', Items.DIAMOND));
